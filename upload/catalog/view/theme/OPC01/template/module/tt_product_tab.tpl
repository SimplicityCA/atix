  ...
  <div id="tab-featured-<?php echo $module; ?>" class="tab-pane">
    <div class="products-carousel">
      ...
      <div class="button-group">
        <button class="btn-cart" type="button"	data-toggle="tooltip" title="<?php echo $button_cart; ?>" onclick="cart.add('<?php echo $product['product_id']; ?>');"><i class="fa fa-shopping-cart"></i> <span class="hidden-xs hidden-sm hidden-md"><?php echo $button_cart; ?></span></button>
