 ...
 <?php echo $text_write; ?></a> -->
          ...
          <div id="product" class="product-options">
            ...
            <div class="form-group product-quantity">
              ...
              <button class="btn btn-primary btn-lg product-btn-cart" type="button" id="button-cart" data-loading-text="<?php echo $text_loading; ?>"><i class="fa fa-shopping-cart"></i>
			...
			<?php foreach ($products as $product) { ?>
			  ...
			  <div class="product-thumb transition">
				...
				<div class="button-group">
				  <button class="btn-cart" type="button" onclick="cart.add('<?php echo $product['product_id']; ?>', '<?php echo $product['minimum']; ?>');"><i class="fa fa-shopping-cart"></i> <span class="hidden-xs hidden-sm hidden-md"><?php echo $button_cart; ?></span></button>
	...
	$.ajax({
		...
		success: function(json) {
			...
			if (json['success']) {
				...
				$('#cart > button').html('<i class="fa fa-shopping-cart"></i> <span id="cart-total" class="cart-quantity cart-quantity-sub">' + json['total'] + '</span>');
